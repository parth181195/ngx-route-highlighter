...
export class AppComponent {
  ...
  newDaATA = [];
  constructor() {
    cdata2.forEach(element => {
      cdata1.forEach(element2 => {
        if (element.alpha_2_code.toLowerCase() === element2.alpha2_code) {
          element['fileName'] = element2.image_name;
          this.newDaATA.push(element);
        }
      });

    });
    console.log(this.newDaATA);
    var blob = new Blob([JSON.stringify(this.newDaATA)], { type: 'data:text;charset=utf-8,' });
...
const cdata1 = [
  ...
  {
    image_name: 'gb-eng.svg',
    alpha2_code: 'gb-eng'
  },
  {
    image_name: 'gb-nir.svg',
    alpha2_code: 'gb-nir'
  },
  {
    image_name: 'gb-sct.svg',
    alpha2_code: 'gb-sct'
  },
  {
    image_name: 'gb-wls.svg',
    alpha2_code: 'gb-wls'
  },
  {
    image_name: 'gb.svg',
